								...
								<form action="https://htmldemo.net/petmark/petmark/">
									<div className="quick-login-form">
										...
										<div className="form-group">
											<label htmlFor="quick-user">Username or email *</label>
											<input type="text" placeholder=""/>
										</div>
										<div className="form-group">
											<label htmlFor="quick-user">Password *</label>
											<input type="text" placeholder=""/>
										</div>
										<div className="form-group">
											<div className="d-flex align-items-center">
												...
												<div className="d-inline-flex align-items-center  ms-3">
													...
													<label htmlFor="accept_terms" className="mb-0">I’ve read and accept the terms &amp; conditions</label>
												</div>
											</div>
								...
								<div className="col-12">
									<div className="checkout-cart-total">
										...
										<div className="term-block">
											...
											<label htmlFor="accept_terms2">I’ve read and accept the terms & conditions</label>
										</div>
